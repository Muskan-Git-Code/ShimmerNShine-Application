...
public final class book_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("</style>\n");
      out.write("  </head>\n");
      out.write("  <body style=\"background: url(https://thecrimsonbride.com/wp-content/uploads/2020/02/Top-Wedding-Themes-50-768x512.jpg) no-repeat; background-size: cover; background-attachment: fixed;\">\n");
      out.write("<!--    <nav>\n");
      ...
      out.write("                \n");
      out.write("            <label class=\"fm\" >User ID</label>    \n");
      out.write("                <input type=\"text\" id=\"guest\" name=\"id\" placeholder=\"Enter ID\"  required>\n");
      out.write("                \n");
      out.write("                <br><br>\n");
      out.write("                <label class=\"fm\" >No. of Guests</label>\n");
      out.write("                <input type=\"text\" id=\"guest\" name=\"guest\" placeholder=\"50\"  required>\n");
      out.write("        \n");
      out.write("                <br><br>\n");
      out.write("            <label class=\"fm\" >Event Starting Date</label>\n");
      out.write("    <input type=\"text\" id=\"checkin-date\" name=\"checkin\" required>\n");
      out.write("                \n");
      out.write("                <br><br>\n");
      out.write("                \n");
      out.write("                <label class=\"fm\" name=\"checkout-date\">Event Ending Date</label>\n");
      out.write("    <input type=\"text\" id=\"checkout-date\" name=\"checkout\" required>\n");
      out.write("    <br><br>\n");
      out.write("            \n");
      out.write("                <label class=\"fm\" name=\"venue-selection\">Select Venue Preference</label>\n");
      out.write("                <select id=\"venue-selection\" name=\"venue\" required>\n");
      out.write("                <option value=\"\">Choose a venue from the List</option>\n");
      out.write("                <option value=\"hall_1\">Hall 1</option>\n");
      out.write("                <option value=\"hall_2\">Hall 2</option>\n");
      out.write("                <option value=\"hall_3\">Hall 3</option>\n");
...
//         String stdate=request.getParameter("checkin").toString();
//         String endate=request.getParameter("checkout").toString();
//         String gu=request.getParameter("guest").toString();
//         String vn=request.getParameter("venue").toString();
//          String us=request.getParameter("id").toString();
//        try
//	{
